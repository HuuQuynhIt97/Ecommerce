...
@Component({
  selector: 'app-consumption-3',
  templateUrl: './consumption-3.component.html',
  styleUrls: ['./consumption-3.component.scss']
})
export class Consumption3Component extends BaseComponent implements OnInit {
  ...
  public queryCellInfoEvent: EmitType<QueryCellInfoEventArgs> = (args: QueryCellInfoEventArgs) => {
    ...
    const fields = ['modelName', 'modelNo', 'articleNo', 'process', 'line'];
  ...
  consumptionByLineCase3() {
    this.planService.consumptionByLineCase3(this.buildingID, this.startDate, this.endDate).subscribe((res: Consumtion[]) => {
      this.data = res;
    });
  }
  ...
  reportConsumptionCase3() {
    ...
    this.planService.reportConsumptionCase3(this.buildingID, this.startDate, this.endDate).subscribe((data: any) => {
      ...
      link.download = `${startDateFormat}-${endDateFormat}_Consumption3.xlsx`;
      link.click();
      this.spinner.hide();
    });
  }
